...
-- Purpose: Fix missing build_code generation in create_or_get_custom_build
-- Issue: Code 23502 - null value in column "build_code" violates not-null constraint
-- Root: INSERT statement omits build_code, which is required and has no default
--
...
-- Verification: Run this query separately after patch deployment
-- SELECT * FROM create_or_get_custom_build(p_session_token := 'test-session-456');  -- Should return with generated build_code
